...
/* The fixed relationship parts, named so that they are measured with
 * strlen like every other part: a length counted by hand is wrong the
 * first time the text changes, and a zip entry takes it on trust. */
