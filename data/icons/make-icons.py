...
%s
  ...
  <text x="136" y="62" font-family="Cantarell, 'Segoe UI', Ubuntu, sans-serif"
        font-size="44" font-weight="700" fill="#1a5fb4">Word42</text>
  <text x="138" y="86" font-family="Cantarell, 'Segoe UI', Ubuntu, sans-serif"
        font-size="14" fill="#5e5c64">A word processor, written from scratch in C</text>
</svg>
"""
