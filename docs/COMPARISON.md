...
| Open the whole King James Bible (`samples/bible-kjv.docx`: 1 700 pages, 820 000 words, eight pictures, 2.2 MB) | 0.2 s to read, then 3 s to lay out (measured) | several seconds (typical) | tens of seconds (typical) | several seconds (typical) |
